...
const Manager = () => {
  ...
  return (
    <>
      ...
      <div className="duration-300 bg-stone-100 drop-shadow-2xl mx-auto my-4 max-sm:mx-4 max-w-3xl rounded-xl sticky top-14 z-10 bg-opacity-50 backdrop-blur-md border border-gray-200">
